...
const Home = () => {
    return (
        <>
            ...
            <section className="featred-wrapper py-5 home-wrapper-2">
                <div className="container-xxl">
                    <div className="row">
                        <div className="col-12">
                        ...
                        <div className="col-3">
                            <div className="famous-card position-relative">
                                ...
                                <div className="famous-content position-absolute">
                                    ...
                                    <p>From $399 or $16.5/mo for 24 mo.*</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-3">
                        ...
                        <div className="col-3">
                            <div className="famous-card position-relative">
                                ...
                                <div className="famous-content position-absolute">
                                    ...
                                    <p>Now in green From $999.00 or 41.5$/mo</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-3">
